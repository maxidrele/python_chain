...
d=6  # Dimensión del espacio de Hilbert de cada elemento (resonadores y transmones)
...
np.savez('resultados_simulacion_d6.npz', 
         times=times,
...
print("✓ Datos guardados en 'resultados_simulacion_d6.npz'")
...
with open('metadata.json_d6', 'w') as f:
    json.dump(metadata, f, indent=4)

print("✓ Metadatos guardados en 'metadata.json_d6'")

# 4. Crear un archivo de resumen
with open('resumen_simulacion_d6.txt', 'w') as f:
